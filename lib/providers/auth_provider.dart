...
class AuthProvider with ChangeNotifier {
  ...
  Future<void> _initializeAuth() async {
    ...
    // Only authenticate if there's an active Firebase user session
    // Don't auto-authenticate from SharedPreferences on startup
    // This ensures login screen shows on app start
