...
class _ProfileScreenState extends State<ProfileScreen> {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage(normalizeBundledAssetPath('signup/homesign.PNG')),
                        fit: BoxFit.cover,
                        opacity: 0.18,
                      ),
                    ),
                    child: Column(
                      children: [
                        ...
                        if (authed && ((_userData['address'] ?? '').isNotEmpty || (_userData['location'] ?? '').isNotEmpty)) ...[
                          const SizedBox(height: AppSpacing.md),
                          Row(
  ...
  Widget _buildProfileAvatar() {
    ...
    final hasDataUrl = profileImage.startsWith('data:image');
    return CircleAvatar(
      radius: 40,
      ...
      child: hasDataUrl
          ? ClipOval(
              child: Image.memory(
                DataUrlImageDecoder.decode(profileImage),
                width: 80,
                height: 80,
                fit: BoxFit.cover,
